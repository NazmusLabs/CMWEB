...
Version 19.0.20.1127 (Gold)
Patch version: 1.20.1127
...
<head>
  ...
  <title>Lab 8 - CSS 3 &amp; Web Fonts</title>
  <meta charset="UTF-8">
  ...
  <meta name="version" content="19.0.20.1127 (Update 1)">
...
<body>
  ...
  <!--===========================
	...
	===========================-->
  <div id="featured">
    <h1>Lab 8 - CMWEB 120 - NazmusLabs</h1>
  </div>
  <!--=========================
	  🎀 END OF FEATURED 🎀
	=========================-->
    ...
    <div class="container">
      ...
      <--/🔍 Search Box [DISABLED CODE]-->
        ...
        <div class="menu-vertical">
          ...
          <!--🔗 Menu Items-->
          <ul>
            <li><a href="lab1.php"><small>CMWEB 120 Lab 1</small></a></li>
            <!--🔗 Click!-->
            <li><a href="../lab2/lab2.html"><small>CMWEB 120 Lab 2</small></a></li>
            <!--🔗 Click!-->
            <li><a href="../lab3/lab3.html"><small>CMWEB 120 Lab 3</small></a></li>
            <!--🔗 Click!-->
            <li><a href="../lab4/lab4.html"><small>CMWEB 120 Lab 4</small></a></li>
            <!--🔗 Click!-->
            <li><a href="../lab5/lab5.html"><small>CMWEB 120 Lab 5</small></a></li>
            <!--🔗 Click!-->
            <li><a href="../lab6/lab6.html"><small>CMWEB 120 Lab 6</small></a></li>
            <!--🔗 Click!-->
            <li><a href="../lab7/lab7.html"><small>CMWEB 120 Lab 7</small></a></li>
            <!--🔗🚫 Click!-->
            <li><small>CMWEB 120 Lab 8 ✔</small></li>
          </ul>
          <!--/🔗 Menu Items-->
          <p>
      ...
      <article>
        <section>
          ...
          <div class="page-intro">
            <p>This lab involves working with images and colors. The visual presentation of a website is one of the most important considerations—along with the actual content itself—when building a website. The reasoning for this all goes back to ensuring the <em>user experience (UX)</em> of the website is first classs</p>
          </div>
          <!--/📢 Content Intro 📢-->
        </section>
        <!--🔖-->
        ...
        <section>
          <!--🔖-->
          <h2>Demo Form</h2>
          <iframe src="lab8content.html" title="Lab 8 Demo Content:
              Mount Olympus News" height="1800" width="100%" frameborder="0"></iframe>
        </section>
        <!--🔖-->
        <!--/📑 Main Content 📑-->
        <!--🎁 Bonus Content 🎁-->
        ...
        <!--/🎁 Bonus Content 🎁--> <em><small>Featured image credit:
            Photo by <a href="https://unsplash.com/@cadop" target="_blank">Mathew Schwartz</a> on <a
              href="https://unsplash.com/photos/s87bBFZviAU" target="_blank">Unsplash</a>.</small></em>
      </article>
      <!--/////////////////////////////
		   📖 END of Main Article 📖
		  ///////////////////////////-->
