...
<div class="sidebar"> 
  ...
  <div class="menu-vertical">
    ...
    <ul>
      ...
      <!--🔗 Click!-->
      <li><a href="/sites/cmweb241/labs/lab"><small>CMWEB 241 Lab 5</small></a></li>
      <!--🔗🚫 Click!-->
      ...
      <!--🔗 Click!-->
      <li><a href="/sites/cmweb241/labs/lab11</small>CMWEB 241 Lab 11"</a></li>
    </ul>
    <!--/🔗 Menu Items-->
    <p> 
...
<!--💡 Developer Remarks
-------------------------------
The following lines of code are here for text-editors, including Adobe Dreamweaver, and not meant to render at runtime (hese the exit script above).
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
<!--❔This meta tag is to let text editors know to open this file as a UTF-8 file and, therefore, deta loss detaloss
-->