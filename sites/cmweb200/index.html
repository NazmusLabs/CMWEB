...
<title>Nazmus's CMWEB 200 Student Site</title>
<meta charset="UTF-8">
...
<body>
<!--🥤-1-🥤-->
<div class="sys-notif-banner" >
  <p style="padding-left: 1em" ><small></small></p>
</div>
<!--/🥤-1-🥤--> 
<!--==============================
  ...
  <div class="nav-bar"> 
    ...
    <nav class="container-nav"> 
      ...
      <ul class="right-align">
        ...
        <!--🔗 Click!-->
        <li><a class="menu-button" href="https://github.com/NazmusLabs/CMWEB" target="_blank">GitHub</a></li>
      </ul>
      <!--/🔗 Nav-bar Menu Items--> 
    </nav>
    <!--/👆🏻 Main menu--> 
...
<!--🍧-1-🍧-->
<div id="featured">
  <h1>Nazmus's CMWEB 200 Student Site</h1>
</div>
<!--🍧-1-🍧--> 
<!--=========================
	  🎀 END OF FEATURED 🎀
...
<div class="content-section-light"> 
  ...
  <div class="container" style="position: relative"> 
    <!--🍦-2-🍦-->
    <h1>JavaScrtip &amp; Mobile App Development for Web Developers</h1>
    <!--Bismillah--> 
    <!--⚓-->
	...
	==============================-->
      ...
      <section> <!--🔖--> 
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia autem delectus unde! Reiciendis tenetur ipsa sed, doloribus inventore repellendus omnis accusantium corporis laboriosam, facilis, nemo ipsum rerum molestias perferendis adipisci.</p>
        <!--🔖--> 
      </section>
    </article>
  </div>
...
<!--=======================
	 🧁 APPLICATION II  🧁
	=======================-- >
<div class="content-section-grey" id="app2">
<!--🍚-1-🍚-- >
<section> <!--🔖-- > 
  <!--🍟-2-🍟-- >
  <div class="container">
    <h2 style="color: #131A24; padding-top: 2em" >Now You See Me</h2>
    <!--⚓-- >
...
<footer> 
  ...
  <div class="container-wide"> 
    ...
    <!--/ Licence Info --> 
    <!--Copyright Info -->
    <p><small>&copy 2021 Nazmus Shakib Khandaker and NazmusLabs. Some
